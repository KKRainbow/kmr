...
func main() {
	job.Name = "ABC"
	Init()
	countMusicMapper := mapred.GetFunctionMapper(CountMusicMap, mapred.String, mapred.String, mapred.String, mapred.Uint32, func() {})
	countArtistMapper := mapred.GetFunctionMapper(CountArtistMap, mapred.String, mapred.String, mapred.String, mapred.Uint32, func() {})
	countPairMapper := mapred.GetFunctionMapper(CountPairMap, mapred.String, mapred.String, mapred.String, mapred.Uint32, func() {})
	countAllMapper := mapred.GetFunctionMapper(CountAllMap, mapred.String, mapred.String, mapred.String, mapred.Uint32, func() {})
	pmiMapper := mapred.GetFunctionMapper(PMIMapper, mapred.String, mapred.String, mapred.String, mapred.Bytes, func() {})

	aggregateReducer := mapred.GetFunctionReducer(AggregateReducer, mapred.Bytes, mapred.Uint32, mapred.Bytes, mapred.Uint32, func() {})
	pmiReducer := mapred.GetFunctionReducer(PMIReducer, mapred.String, mapred.Bytes, mapred.String, mapred.String, func() {})
	...
	job.Run()
	fmt.Println(countAllMapper, pmiMapper, pmiReducer, callj, pmij)
}
